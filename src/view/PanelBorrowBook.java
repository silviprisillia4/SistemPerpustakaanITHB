                ...
                if(listCheckedBook.size()!=0) {
                    ...
                    if(confirm==JOptionPane.YES_OPTION) {
                        ...
                        for (int i=0; i<listCheckedBook.size(); i++) {
                            ...
                            Borrowing borrowing = new Borrowing(0, book.getIdBook(), member.getIdUser(), member.getIdBranch(), borrowDays, book.getBorrowPrice(), new Date(), 0, 0);
