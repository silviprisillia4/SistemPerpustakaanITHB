...
public class RegexController {
    ...
    public static boolean firstNameValidation(String pass) {
        String regex = "^[a-zA-Z]*.{3,20}$";
        return pass.matches(regex);
    }
    
    public static boolean lastNameValidation(String pass) {
    ...
    public static boolean mobileNumberValidation(String mNumber) {
